...
1. classification_service - Auto-detecci�n de tipo de documento
2. categorization_service - Gesti�n de categor�as por rol
3. template_service - Extracci�n de placeholders de templates Word
4. mapping_service - Mapeo de placeholders a claves est�ndar
5. storage_service - Almacenamiento dual (Drive + Local)
6. ocr_service - OCR async paralelo con Google Vision
7. ai_service - Extracci�n con LLMs (OpenRouter + OpenAI)
8. document_service - Generaci�n de documentos Word
9. email_service - Env�o de emails SMTP (sync + async)
"""
