/**
 * ConversationList
 * Sidebar list of WhatsApp conversations with search and status indicators
 */
...
export function ConversationList({ conversations, selectedId, onSelect }: ConversationListProps) {
  ...
  const filtered = conversations.filter((conv) => {
    ...
    const name = conv.wa_contacts?.name?.toLowerCase() || '';
    const phone = conv.wa_contacts?.phone?.toLowerCase() || '';
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={cn(
                        ...
                        statusDotColor[conv.status] || statusDotColor.pending
                      )}
                    />
                  </div>
